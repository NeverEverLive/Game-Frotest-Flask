...
from src.models.blacklist import BlackList, BlackListSchema
...
def logout_user(token: str) -> Dict[str, Union[str, bool]]:
    """Выйти из системы
    ...
    print(token)
    serializer = BlackListSchema()
    data = serializer.dump(data)

    blacklist = BlackList().fill(**data)
    blacklist.save()
